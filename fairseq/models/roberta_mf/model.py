...
@register_model('roberta_mf')
class RobertaModelMF(FairseqEncoderModel):
...
class RobertaEncoderMF(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, dictionary_cf):
        ...
        self.sentence_encoder = TransformerSentenceEncoderMF(
            padding_idx_dict={field: dictionary[field].pad() for field in dictionary},
            vocab_size_dict={field: len(dictionary[field]) for field in dictionary},
...
@register_model_architecture('roberta_mf', 'roberta_mf')
...
@register_model_architecture('roberta_mf', 'roberta_mf_base')
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture('roberta_mf', 'roberta_mf_large')
...
@register_model_architecture('roberta_mf', 'xlm_mf')
