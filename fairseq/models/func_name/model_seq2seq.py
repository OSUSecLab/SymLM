...
@register_model('func_name_seq2seq')
class FuncNameTranslationModel(FairseqEncoderDecoderModel):
...
@register_model_architecture('func_name_seq2seq', 'func_name_seq2seq')
