...
@register_model('func_name_seq2seq_cls')
class FuncNameCLSTranslationModel(FairseqEncoderDecoderModel):
    ...
    def forward(
        ...
        encoder_out = self.encoder(src_tokens, features_only, return_all_hiddens, **kwargs)
...
@register_model_architecture('func_name_seq2seq_cls', 'func_name_seq2seq_cls')
