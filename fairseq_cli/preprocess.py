...
# cmd = "--only-source --srcdict ../data-bin/label_dict.txt --trainpref ../data-src/finetune/mips-O0/train.label --validpref ../data-src/finetune/mips-O0/valid.label --destdir ../data-bin/finetune/mips-O0/label --workers 40"
...
def main(args):
    ...
    # print(dict_path(args.source_lang))
    # dict_path(args.source_lang) = ../data-bin/finetune/mips-O0/label/dict.txt
