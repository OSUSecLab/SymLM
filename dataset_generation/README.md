...
We provide sample `x64` binaries under [`sample_binary/x64/O0/bc/`](sample_binary/x64/O0/bc). By running our script, the generated dataset is under [`sample_output/bc`](sample_output/bc) and its structure is:
